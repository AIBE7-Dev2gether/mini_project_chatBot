...
Supabase Auth는 유지합니다. 기존 계정 9건, 대화방 4건, 메시지 28건을 이관했으며 원본/대상의 내용, UTC 시간과 외래키 무결성을 검증했습니다. 수행 기록은 [마이그레이션 기록](docs/archive/SPRING_BOOT_JPA_AIVEN_MYSQL_MIGRATION.md)에 보관합니다.
...
- [Spring Boot/JPA/Aiven 마이그레이션 기록](docs/archive/SPRING_BOOT_JPA_AIVEN_MYSQL_MIGRATION.md)
